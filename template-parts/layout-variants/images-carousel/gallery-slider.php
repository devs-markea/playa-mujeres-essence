...
<style>
    ...
    .images-carousel.images-carousel--gallery-slider .images-carousel__caption-text{
        margin: 0;
    }

    /* Paginación (scope al variant) */
    .images-carousel.images-carousel--gallery-slider .images-carousel__pagination { display: block; }
    ...
    @media (min-width: 768px) {
        ...
        .images-carousel.images-carousel--gallery-slider .images-carousel__image { height: 580px; }
    }
</style>

<script>
    (function () {
        function initImagesCarouselSwiperss() {
        ...
        window.addEventListener('load', initImagesCarouselSwiperss);
    })();
</script>