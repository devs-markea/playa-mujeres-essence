<?php
/**
 * template-parts/layout-variants/content-highlights/essence.php
 *
 ...
 */
?>
<section data-anim="slide-up delay-2" class="content-highlights content-highlights--essence<?php echo $section_uid ? ' ' . esc_attr( $section_uid ) : ''; ?>">
            ...
            <div class="col-12 col-md-10 mx-auto">
                ...
                <?php if ($highlights_items) : ?>
                    <div class="content-highlights__items row g-0 g-md-3 ">
                        ...
                        ?>
                            <div class="col-12 col-md-3 content-highlights__item">
