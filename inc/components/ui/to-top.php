...
<style>
    ...
    .toTopButton {
        ...
        border-radius: 100%;
        border: 1px solid var(--pm-primary-900);
        transition: .15s;
        z-index: 500;
        display: flex;
    ...
    .toTopButton .icon-down-arrow {
        width: 24px;
        height: 24px;
        fill: var(--pm-primary-900);
    }
    .toTopButton:hover .icon-down-arrow {
        fill: white;
    }

    .toTopButton:hover{
        background-color: var(--pm-primary-900);
    }
